 ...
 function [totalPower] = setYawAndInductionGetPower(arduinoSerial,yaw)     %value is in mA, min 0 max 400
 ...
 servalue = sprintf('%d;', 6, yaw1, yaw2, yaw3, induction1, induction2, induction3);        
