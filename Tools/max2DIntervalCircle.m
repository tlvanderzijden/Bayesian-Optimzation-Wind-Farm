function max2DInterval = max2DIntervalCircle(maxDist, probabilityInterval, x1Mesh, x2Mesh)
%This function computes a circular confidence interval of the 2-input maximum distribution
