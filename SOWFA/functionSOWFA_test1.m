...
%This is a basic which function computes a next measurement point with Gaussian Processes and Bayesian Optimization 
%It is used together with SOWFA high fidelity simulation windfarm simulation 
%It has an input struct and about struct saving all the necessary information
varExperiment = SOWFA_two_dimensional_test1_19_12;
...
if iteration <= nInitialPoints
    ...
    if acqfunc == 1
        ...
        [~, powerOpt] = optimizeAcquisitionFunction(@(x)acqEV(hyp,inffunc, meanfunc, covfunc,likfunc,sYaw,sPower,xMin , xMax, nStarts));
