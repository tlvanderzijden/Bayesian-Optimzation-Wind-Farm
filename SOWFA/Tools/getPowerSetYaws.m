function [yaws,BayesOpt] = getPowerSetYaws(totalPower,BayesOpt)
...
nInputs = 1; % This is the number of try-out inputs every acquisition function can try during a full run.
